...
#define pISR_IRQ       (*(unsigned volatile*)(ISR_BADDR+0x18))
#define pISR_FIQ       (*(unsigned *)(ISR_BADDR+0x1c))

#define aISR_EINT0     (ISR_BADDR+0x20)

#define pISR_WDT     	(*(unsigned *)(ISR_BADDR+0x24))                           
#define pISR_EXTINT0     		(*(unsigned *)(ISR_BADDR+0x28))                     
#define pISR_EXTINT1    		(*(unsigned *)(ISR_BADDR+0x2c))                     
#define pISR_EXTINT2  		(*(unsigned *)(ISR_BADDR+0x30))                       
#define pISR_EXTINT3  		(*(unsigned *)(ISR_BADDR+0x34))                       
                                                                                
#define pISR_SPU  			(*(unsigned *)(ISR_BADDR+0x38))                         
#define pISR_I2S	  		(*(unsigned *)(ISR_BADDR+0x3c))                         
                                                                                
#define pISR_VPOST	     	(*(unsigned *)(ISR_BADDR+0x40))                       
#define pISR_VIDEOIN       	(*(unsigned *)(ISR_BADDR+0x44))//9                  
#define pISR_GPU    		(*(unsigned *)(ISR_BADDR+0x48))//10                     
#define pISR_BLT   		(*(unsigned *)(ISR_BADDR+0x4c))//11                       
#define pISR_FSC 			(*(unsigned *)(ISR_BADDR+0x50))//12                       
                                                                                
#define pISR_HUART    		(*(unsigned volatile *)(ISR_BADDR+0x54))//13          
#define pISR_TMR0   		(*(unsigned *)(ISR_BADDR+0x58))//14                     
                                                                                
                                                                                
#define pISR_TMR1     	(*(unsigned *)(ISR_BADDR+0x5c))                         
#define pISR_UDC      	(*(unsigned *)(ISR_BADDR+0x60))                         
                                                                                
#define pISR_SIC      (*(unsigned *)(ISR_BADDR+0x64))                           
#define pISR_UHC      (*(unsigned *)(ISR_BADDR+0x68))                           
#define pISR_EDMA      (*(unsigned *)(ISR_BADDR+0x64))                          
#define pISR_SPIMS0      (*(unsigned *)(ISR_BADDR+0x68))                        
                                                                                
#define pISR_SPIMS1      	(*(unsigned *)(ISR_BADDR+0x6c))                       
#define pISR_ADC      	(*(unsigned *)(ISR_BADDR+0x70))                         
                                                                                
#define pISR_RTC       	(*(unsigned *)(ISR_BADDR+0x74))                         
	
#define pISR_UART     		(*(unsigned *)(ISR_BADDR+0x78))
#define pISR_PWM	     	(*(unsigned *)(ISR_BADDR+0x7c))
#define pISR_JPG	 		(*(unsigned *)(ISR_BADDR+0x80))

#define pISR_REV      		(*(unsigned *)(ISR_BADDR+0x84))
#define pISR_KPI      		(*(unsigned *)(ISR_BADDR+0x88))

#define pISR_SPI       		(*(unsigned *)(ISR_BADDR+0x8c))

#define pISR_DES     		(*(unsigned *)(ISR_BADDR+0x90))
#define pISR_I2C      	(*(unsigned *)(ISR_BADDR+0x94))
#define pISR_PWR      		(*(unsigned *)(ISR_BADDR+0x98))
